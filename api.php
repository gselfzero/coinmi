...
define("DB_HOST", "localhost"); //Сервер базы данных
define("DB_USERNAME", "id11751009_coin"); //Пользователь базы данных
define("DB_PASSWORD", "vfrcbv22"); //Пароль от пользователя базы данных
define("DB_NAME", "id11751009_coin"); //Имя базы данных
define("APP_SECRET", "hr2BFzjXU9qGpwMQNYjH"); //Защищенный ключ приложения
define("SERVICE_KEY", "cdf513a1cdf513a1cdf513a133cd9b26a9ccdf5cdf513a19029510ad7c1dfceb419964a");
